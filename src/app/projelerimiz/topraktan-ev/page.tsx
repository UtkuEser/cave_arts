...
export const metadata: Metadata = {
  title: "Topraktan Ev | CaveArts Projelerimiz",
  description:
    "CaveArts, erken aşama gayrimenkul projelerini yatırım değeri, lokasyon potansiyeli ve doğru satış modeliyle birlikte değerlendirir.",
}

const avantajlar = [
  {
    baslik: "Erken Aşama Fırsatı",
    aciklama: "Projenin toprak aşamasında erken giriş, yatırımcıya en yüksek değer artışı potansiyelini sunar.",
  },
  {
    baslik: "Şeffaf Ödeme Planı",
    aciklama: "Ara ödeme ve ek ödeme olmaksızın, net ve planlı bir taksit yapısıyla yatırım süreci yönetilir.",
  },
  {
    baslik: "Tapu Güvencesi",
    aciklama: "Her aşamada resmi tapu süreci şeffaf biçimde takip edilir ve yatırımcıya raporlanır.",
  },
  {
    baslik: "Lokasyon Analizi",
    aciklama: "Projenin bulunduğu bölgenin gelişim potansiyeli ve değer artış dinamikleri detaylı analiz edilir.",
  },
]

export default function TopraktanEvPage() {
  return (
    <>
      <Sidebar />
      <div className="lg:ml-[80px]">
        ...
        <section
          ...
          style={{ backgroundColor: "#07091A", minHeight: 420 }}
        >
          <div
          ...
          <div
            className="absolute inset-0 pointer-events-none"
            aria-hidden="true"
            style={{ background: "radial-gradient(ellipse at 40% 55%, rgba(8,10,28,0.75) 0%, transparent 65%)" }}
          />
          ...
          >
            ...
            >
              CaveArts, erken aşama gayrimenkul projelerini yatırım değeri, lokasyon
              potansiyeli ve doğru satış modeliyle birlikte değerlendirir.
            </p>
          </div>
        </section>
              ...
              {avantajlar.map((item, i) => (
                <div
                  ...
                  style={{
                    ...
                    paddingTop: 28,
                    paddingBottom: 28,
                    paddingRight: i < avantajlar.length - 1 ? "clamp(16px, 3vw, 40px)" : 0,
                  }}
                >
                  <p
                    className="font-sans"
                    style={{ fontSize: "8.5px", letterSpacing: "0.22em", color: "#C9A86C", marginBottom: 16 }}
                  >
        ...
        <section style={{ backgroundColor: "#111317" }}>
          ...
          >
            ...
            >
              CaveArts danışmanları, topraktan ev yatırımı hakkında sizinle görüşmek için hazır.
            </p>
